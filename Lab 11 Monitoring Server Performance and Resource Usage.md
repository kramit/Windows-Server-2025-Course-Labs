...
::: secondary
In this lab, you will use Windows Server tools to monitor system performance, collect a short performance baseline, generate controlled activity, and compare the results. You will use Task Manager, Resource Monitor, Performance Monitor, Data Collector Sets, Event Viewer, File Explorer, and Windows PowerShell.
...
## Exercise 10: Clean Up Temporary Lab Files

::: secondary
**Scenario**

You created temporary files to generate disk activity. You should remove them before finishing the lab so the server is left in a cleaner state.
:::
...
## Exercise 11: Record the Administrative Monitoring Summary
