...
5. [ ] Look for **Hyper-V** in the roles list and check the box next to it.
6. [ ] A dialog will appear asking to add required features. Click **Add Features**.
7. [ ] Continue through the wizard to **Confirmation** page.
8. [ ] Click **Install** to install Hyper-V.
9. [ ] Installation may take 5-10 minutes. Wait for completion.
10. [ ] You will be prompted to restart the server. Click **Restart Now** or schedule the restart.
...
5. [ ] Hyper-V Manager will open showing your server.
6. [ ] You can now create and manage virtual machines.
