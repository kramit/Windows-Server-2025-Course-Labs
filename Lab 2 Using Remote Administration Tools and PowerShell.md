...
You need to run administrative commands on LON-DC1 without opening a separate graphical console session. You will use PowerShell remoting from LON-SVR1 to query information from LON-DC1.
:::
